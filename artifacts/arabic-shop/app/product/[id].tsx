    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.galleryContainer}>
          ...
          <TouchableOpacity
            style={[styles.floatBtn, styles.wishBtn]}
          ...
          <TouchableOpacity style={[styles.floatBtn, styles.shareBtn]}>
            ...
            {product.deliveryDays && (
              <View style={styles.deliveryBadge}>
                <Text style={styles.deliveryText}>
                  توصيل خلال {product.deliveryDays} أيام ⚡
                </Text>
              </View>
            )}
          </View>
            ...
            {savings > 0 && (
              <View style={styles.savingsRow}>
                ...
                <Text style={styles.savingsText}>
                  وفرت {savings.toLocaleString("ar-SA")} ر.س في هذا المنتج
                </Text>
              </View>
            )}
          </View>
                ...
                <View
                  style={[
                    styles.stockFill,
                    {
                      width: `${soldPct}%`,
                      backgroundColor:
                        soldPct > 80 ? colors.primary : colors.success,
                    },
                  ]}
                />
              </View>
                  ...
                  >
                    <Text
                      style={[
                        ...
                        {
                          color:
                            selectedSize === size ? "#fff" : colors.text,
                        },
                      ]}
                    >
                      {size}
          ...
          {product.colors && product.colors.length > 0 && (
            <View style={styles.colorsSection}>
              <Text style={[styles.sectionLabel, { marginBottom: 10 }]}>
                اللون{" "}
                {selectedColor && (
                  <Text style={{ color: colors.primary, fontFamily: "Cairo_400Regular" }}>
                    · تم الاختيار
                  </Text>
                )}
              </Text>
              ...
              {[5, 4, 3, 2, 1].map((star, i) => {
                ...
                return (
                  <View key={star} style={styles.barRow}>
                    ...
                    <Text style={[styles.barLabel, { width: 20 }]}>
                      {starCounts[i]}
                    </Text>
                  </View>
                );
          ...
          <>
            ...
            >
              <TouchableOpacity onPress={() => router.push("/(tabs)/search" as any)}>
                <Text style={{ fontSize: 13, fontFamily: "Cairo_600SemiBold", color: colors.primary }}>
                  عرض الكل
                </Text>
              </TouchableOpacity>
              <Text
      ...
      >
        <View style={styles.totalRow}>
          <Text style={styles.totalLabel}>
            الإجمالي ({quantity} {quantity === 1 ? "قطعة" : "قطع"})
          </Text>
